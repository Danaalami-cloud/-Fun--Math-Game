...
// refresh Spalsh Page Best Scores
...
function updateBestScore() {
  bestScoreArray.forEach((score, index) => {
    ...
    if (questionAmount == score.questions){
      ...
      // Update if the new final score is lesss or replacing zero
...
// Scroll, Store user selection in payerGuess Array
...
function createEquations() {
  ...
  // Loop throuh for each correct equation, multiply random numbers
...
// Dynamically adding correct/incorrect equations
  ...
  // Navigate from splash page to coutndownpage to Game page
